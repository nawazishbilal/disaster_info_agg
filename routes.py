...
MODEL_PATH = "improved_xgb_model.json"
...
def predict():
    ...
    # Convert tweet into embedding
    transformed_tweet = embedder.encode([tweet])

    # Convert to DMatrix for XGBoost
    dmatrix_tweet = xgb.DMatrix(transformed_tweet)

    try:
        proba = model.predict_proba(np.array(transformed_tweet))[0][1]  # Class 1 probability
        ...
        #dehugging
        # print("Tweet:", tweet)
        # print("Embedding shape:", np.array(transformed_tweet).shape)
